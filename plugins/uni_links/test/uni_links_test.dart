...
void main() {
  ...
  final testBinaryMessenger = TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger;

  setUp(() {
    testBinaryMessenger.setMockMethodCallHandler(mChannel, (MethodCall methodCall) async {
      log.add(methodCall);
      return null;
    });
  });
  ...
  tearDown(() {
    log.clear();
    testBinaryMessenger.setMockMethodCallHandler(mChannel, null);
  });
