...
PropertyAmenityModel _$PropertyAmenityModelFromJson(
...
Map<String, dynamic> _$PropertyAmenityModelToJson(
  PropertyAmenityModel instance,
) => <String, dynamic>{
  'id': instance.id,
...
PropertyAmenityResponse _$PropertyAmenityResponseFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$PropertyAmenityResponseToJson(
  PropertyAmenityResponse instance,
) => <String, dynamic>{
  'id': instance.id,
  'title': instance.title,
  'icon': instance.icon,
