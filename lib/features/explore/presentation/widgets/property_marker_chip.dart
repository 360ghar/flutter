...
class PropertyMarkerChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color bg = selected ? AppDesign.primaryYellow : AppDesign.surface;
    final Color border = selected ? AppDesign.accentOrange : AppDesign.accentBlue;
    final Color text = selected ? AppDesign.buttonText : AppDesign.textPrimary;
